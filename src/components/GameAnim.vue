<!-- game but with animations -->
<!-- TODO: refactor state management to match anim-less version -->
...
<template>
    ...
    <TransitionGroup name="list" tag="div">
        <!-- <span v-for="(char, index) in indexed_pi_slice" :key="char.index">{{ char.char }}</span> for animation -->
    </TransitionGroup>
